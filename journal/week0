...
- [Install the Terraform CLI](#install-the-terraform-cli)
  * [Conisderations with the Terraform CLI changes](#conisderations-with-the-terraform-cli-changes)
  ...
  * [Github Lifecycle (Init, Begfore, Command)](#github-lifecycle--init--begfore--command-)
